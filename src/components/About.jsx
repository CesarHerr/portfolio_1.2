...
function About() {
  ...
  return (
    <section
      className='h-screen relative hidden items-end gap-2 xl:gap-4 pr-4 md:flex flex-col xl:pr-20
      ...
      <h3 className='w-11/12 text-left text-3xl lg:text-4xl xl:text-5xl mt-[15%] text-myBlue dark:text-myLightBlue'>
        {t('about.developer')}
      </h3>
      <p className='w-11/12 text-left text-xl xl:text-2xl'> {t('about.me')}</p>
