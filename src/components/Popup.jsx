  ...
  const allProjects = [
    {
      ...
      description: t('popup.project1.description'),
    ...
    },
    {
      ...
      description: t('popup.project2.description'),
    ...
    },
    {
      ...
      description: t('popup.project3.description'),
    ...
    },
    {
      ...
      description: t('popup.project4.description'),
    ...
    },
    {
      ...
      description: t('popup.project5.description'),
    ...
    },
    {
      ...
      description: t('popup.project6.description'),
